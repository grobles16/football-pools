...
<html>
    <head>
        ...
        <link href="{{ asset('backend/plugins/uniform/css/uniform.default.min.css') }}" rel="stylesheet"/>
        ...
        <link href="{{ asset('backend/plugins/metrojs/MetroJs.min.css') }}" rel="stylesheet" type="text/css"/>	
        ...
        <link href="{{ asset('backend/css/themes/white.css') }}" class="theme-color" rel="stylesheet" type="text/css"/>
        <link href="{{ asset('backend/css/custom.css') }}" rel="stylesheet" type="text/css"/>
        
        <script src="{{ asset('backend/plugins/3d-bold-navigation/js/modernizr.js') }}"></script>
        <script src="{{ asset('backend/plugins/offcanvasmenueffects/js/snap.svg-min.js') }}"></script>
    ...
    <body class="page-header-fixed">
        ...
        <script src="{{ asset('backend/plugins/uniform/jquery.uniform.min.js') }}"></script>
        <script src="{{ asset('backend/plugins/offcanvasmenueffects/js/classie.js') }}"></script>
        <script src="{{ asset('backend/plugins/offcanvasmenueffects/js/main.js') }}"></script>
        ...
        <script src="{{ asset('backend/plugins/jquery-counterup/jquery.counterup.min.js') }}"></script>
        ...
        <script src="{{ asset('backend/plugins/metrojs/MetroJs.min.js') }}"></script>
        <script src="{{ asset('backend/js/modern.min.js') }}"></script>
